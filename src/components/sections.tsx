...
/* Re-exported so every existing `import { JumpNav } from '@/components/sections'`
   keeps working. Importing a client component into a server module and passing
   it through is fine — the boundary travels with the component, not with the
   file that names it. */
export { JumpNav } from '@/components/JumpNav'
