// AUTO-GENERATED offline icon set. Registers only the tabler icons the site
// actually uses, so <Icon> from @iconify/react renders inline SVG on the server
// with no runtime Iconify API call. If you add a new tabler:* icon anywhere,
// add its name to this list and regenerate.
