...
export const applications: Application[] = [
  {
    ...
    metaDesc: 'Natural diamond grit, metal bond, and fine powders for dental bur, rotary instrument, and disc makers. Consistent, sinterable grades from an in-house QC manufacturer.',
    eyebrow: 'Application · Dental',
    cardDesc: 'Natural grit and metal bond for sintered burs, rotary instruments, and diamond discs.',
    intro: [
    ...
    cta: 'Request a Quote',
    ctaDesc: 'Tell us the instrument, the grade, and the volume, and a real person replies within one business day.',
  },
  {
    ...
    metaDesc: 'Fine and polycrystalline diamond micron powder for wafer dicing, lapping, thinning, and polishing in semiconductor and advanced electronics manufacturing.',
    ...
    cta: 'Request a Quote',
    ctaDesc: 'Tell us the substrate, the process step, and the grade or finish you need, and a real person replies within one business day.',
  ...
  },
  {
    ...
    metaDesc: 'CBN for hardened steel grinding, PCBN for hard-turning, PCD for aluminium and composites. Superabrasives for automotive and aerospace tool makers.',
    ...
    cta: 'Request a Quote',
    ctaDesc: 'Tell us the operation, the material you are cutting or grinding, and the grade, and a real person replies within one business day.',
  ...
  },
  {
    ...
    metaDesc: 'Single crystal, MCD, PCD and PCBN blanks, and natural tool stones for cutting-tool, single-point, and dressing-tool makers. Made-to-spec superabrasives.',
    ...
    cta: 'Request a Quote',
    ctaDesc: 'Tell us the tool, the material it machines, and the tolerance, and a real person replies within one business day.',
  ...
  },
  {
    ...
    metaDesc: 'Natural grit, metal bond, CBN, and resin bond diamond for saw segments, grinding wheels, drill bits, and cutting tools. Consistent grades, in-house QC.',
    ...
    cta: 'Request a Quote',
    ctaDesc: 'Tell us the tool, the material it works, and the grade, and a real person replies within one business day.',
  ...
  },
  {
    ...
    metaDesc: 'Micron and polycrystalline diamond powder for fine and optical polishing and lapping. Tight size distribution, sub-nanometer finishes, in-house QC.',
    ...
    whyCta: 'See how our micron QC works',
    cta: 'Request a Quote',
    ctaDesc: 'Tell us the material, the stage, and the finish you are targeting, and a real person replies within one business day.',
    guides: ['How size distribution affects tool performance'],
