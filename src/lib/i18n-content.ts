...
const withGenerated = <T>(hand: Overrides<T>, locale: Locale, gen: Record<string, Record<string, unknown>> | undefined): Record<string, Partial<T>> | undefined => {
  ...
  if (handTable)
    for (const [slug, fields] of Object.entries(handTable)) {
      out[slug] = { ...out[slug], ...fields }
    }
  return out
}

const mergeBySlug = <T extends { slug: string }>(base: T[], table: Record<string, Partial<T>> | undefined): T[] => {
...
const applicationOverrides: Overrides<Application> = {
  de: {
    dental: {
      name: 'Dental',
      cardDesc: 'Metallbindung und feine Pulver für gesinterte Bohrer, Rotationsinstrumente und Trennscheiben.',
    ...
    'semiconductor-electronics': {
      name: 'Halbleiter & moderne Elektronik',
      cardDesc: 'Feine Mikron- und polykristalline Pulver für Dicing, Läppen und Wafer-Politur.',
    ...
    'automotive-aerospace': {
      ...
      cardDesc: 'CBN und PCBN zum Schleifen und Hartdrehen von gehärtetem Stahl; PCD für Aluminium und Verbundwerkstoffe.',
    ...
    'tool-and-die': {
      ...
      cardDesc: 'Einkristall, MCD sowie PCD/PCBN-Rohlinge für Schneid-, Abricht- und Präzisionswerkzeuge.',
    ...
    'grinding-cutting-sawing-drilling': {
      name: 'Schleifen, Schneiden, Sägen & Bohren',
      cardDesc: 'Naturkörnung, Metallbindung und CBN für Segmente, Scheiben und Bohrer.',
    ...
    'polishing-lapping': {
      name: 'Polieren & Läppen',
      cardDesc: 'Mikron- und polykristalline Pulver für Fein- und optisches Finish.',
  ...
  es: {
    dental: {
      name: 'Dental',
      cardDesc: 'Enlace metálico y polvos finos para fresas sinterizadas, instrumentos rotatorios y discos.',
    ...
    'semiconductor-electronics': {
      name: 'Semiconductores y electrónica avanzada',
      cardDesc: 'Polvos finos de micras y policristalinos para corte, lapeado y pulido de obleas.',
    ...
    'automotive-aerospace': {
      name: 'Automoción y aeroespacial',
      cardDesc: 'CBN y PCBN para rectificado y torneado en duro de acero endurecido; PCD para aluminio y compuestos.',
    ...
    'tool-and-die': {
      name: 'Utillaje y matricería',
      cardDesc: 'Monocristal, MCD y preformas de PCD/PCBN para herramientas de corte, diamantado y precisión.',
    ...
    'grinding-cutting-sawing-drilling': {
      name: 'Rectificado, corte, aserrado y perforación',
      cardDesc: 'Grano natural, enlace metálico y CBN para segmentos, muelas y brocas.',
    ...
    'polishing-lapping': {
      name: 'Pulido y lapeado',
      cardDesc: 'Polvos de micras y policristalinos para acabado fino y óptico.',
...
/* ------------------------------- GETTERS --------------------------------- */
export const getProducts = (locale: Locale): Product[] => mergeBySlug(productsEN, withGenerated(productOverrides, locale, generated[locale]?.products))
export const getProduct = (locale: Locale, slug: string): Product | undefined => getProducts(locale).find((p) => p.slug === slug)
export const getApplications = (locale: Locale): Application[] => mergeBySlug(applicationsEN, withGenerated(applicationOverrides, locale, generated[locale]?.applications))
export const getApplication = (locale: Locale, slug: string): Application | undefined => getApplications(locale).find((a) => a.slug === slug)
...
export const getSectionCatalog = (locale: Locale, slug: string, sectionId: string): SectionCatalog | undefined => {
...
const ui: Partial<Record<Locale, Dict>> = {
  ...
  en: {
    footerAbout: 'Manufacturer and finisher of the complete range of industrial diamond and superabrasive materials, supplying tool makers worldwide from London.',
  },
  de: {
    Home: 'Startseite',
    Products: 'Produkte',
    ...
    'Quality, QC & ISO 9001': 'Qualität, QC & ISO 9001',
    'Resources & Guides': 'Ressourcen & Leitfäden',
    Datasheets: 'Datenblätter',
    MSDS: 'Sicherheitsdatenblätter',
    'ISO 9001 Certified': 'ISO 9001 zertifiziert',
    'In-House QC Laboratory': 'Eigenes QC-Labor',
    'Complete Superabrasive Range': 'Komplettes Superschleifmittel-Programm',
    Sections: 'Abschnitte',
    "50+ Years' Experience": '50+ Jahre Erfahrung',
    'London, UK': 'London, UK',
    'Company & Resources': 'Unternehmen & Ressourcen',
  ...
  es: {
    ...
    'Quality, QC & ISO 9001': 'Calidad, QC e ISO 9001',
    ...
    'In-House QC Laboratory': 'Laboratorio de QC propio',
    'Complete Superabrasive Range': 'Gama completa de superabrasivos',
    Sections: 'Secciones',
    "50+ Years' Experience": 'Más de 50 años de experiencia',
    'London, UK': 'Londres, Reino Unido',
    'Company & Resources': 'Empresa y recursos',
  ...
  it: {
    ...
    'Email Us:': 'Email:',
    'Based In:': 'Sede:',
    'Products Overview': 'Panoramica prodotti',
    'Quality, QC & ISO 9001': 'Qualità, QC e ISO 9001',
    'Resources & Guides': 'Risorse e guide',
    Datasheets: 'Schede tecniche',
    MSDS: 'Schede di sicurezza',
    'ISO 9001 Certified': 'Certificato ISO 9001',
    'In-House QC Laboratory': 'Laboratorio QC interno',
    'Complete Superabrasive Range': 'Gamma completa di superabrasivi',
    Sections: 'Sezioni',
    "50+ Years' Experience": 'Oltre 50 anni di esperienza',
    'London, UK': 'Londra, Regno Unito',
    'Company & Resources': 'Azienda e risorse',
  ...
  ja: {
    ...
    'Email Us:': 'メール:',
    'Based In:': '所在地:',
    'Products Overview': '製品一覧',
    'Quality, QC & ISO 9001': '品質・QC・ISO 9001',
    'Resources & Guides': 'リソース＆ガイド',
    Datasheets: 'データシート',
    MSDS: '安全データシート',
    'ISO 9001 Certified': 'ISO 9001 認証',
    'In-House QC Laboratory': '自社QCラボ',
    'Complete Superabrasive Range': '超砥粒フルレンジ',
    Sections: 'セクション',
    "50+ Years' Experience": '50年以上の実績',
    'London, UK': '英国ロンドン',
    'Company & Resources': '会社・リソース',
...
export const t = (locale: Locale, key: string): string => ui[locale]?.[key] ?? generated[locale]?.ui?.[key] ?? key
