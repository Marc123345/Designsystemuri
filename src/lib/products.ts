...
export const products: Product[] = [
  /* ====================== 1 · NATURAL DIAMOND GRIT & POWDER ================= */
  {
    ...
    metaDesc: 'Natural diamond grit in graded mesh sizes and micron powder for grinding, sawing, dressing, lapping, and polishing. Crushed and graded in-house, ISO 9001.',
    eyebrow: 'Products · Group 1',
    cardDesc: 'Natural mesh, micron powder, and rotary diamond, crushed, sorted, and graded in-house for grinding, lapping, dressing, and drilling.',
    overviewDesc: 'Crushed and graded in-house. Mesh grit for grinding, sawing, and dressing; micron powder for lapping and polishing; natural rotary diamonds for drilling and truing.',
    intro: [
    ...
    sections: [
      {
        ...
        intro: ['EID manufactures natural diamond grit in standard and custom mesh sizes for grinding, sawing, dressing, and lapping. Crushed, shaped, and graded in-house, then verified, so sizing holds order to order.'],
        applicationsTitle: 'Typical Applications',
        applications: ['Grinding wheels and segments for stone, glass, and construction materials.', 'Saw blades and wire saws for stone and concrete.', 'Dressing tools for truing conventional grinding wheels.', 'Lapping and rough-polishing of hard, brittle materials.'],
        applicationsNote: "The common thread is non-ferrous, non-metallic work where natural diamond's hardness and edge retention earn their place. For hardened or ferrous steels, diamond wears too fast; use [CBN](/products/cbn) instead.",
        specsTitle: 'Grit specifications',
        specs: [],
        specsNote: 'Need a size or grade not listed? [Ask our technical team](/contact) and we will confirm availability and lead time.',
      ...
      },
      {
        ...
        intro: ['We also supply natural rotary diamonds for dressing and truing, selected in-house from natural grades. These are enquiry-led rather than stocked to a fixed catalogue. Tell us the wheel and the dressing operation and we will match the stone.'],
      ...
      },
      {
        ...
        applicationsNote: 'Where the specification is a surface quality rather than a stock-removal rate, this is the grade family that gets you there.',
    ...
    sections: [
      {
        ...
        intro: ['Mesh grades cover the coarse-to-medium CBN range that goes into vitrified and resin-bonded grinding wheels for ferrous work at volume, monocrystalline for toughness on interrupted cuts, microcrystalline where a self-sharpening action suits the wheel.'],
        callouts: [
          {
        ...
        applicationsTitle: 'Typical Applications',
        applications: ['Vitrified and resin-bonded CBN grinding wheels for hardened steel.', 'Automotive crankshaft, camshaft, and gear grinding.', 'Aerospace superalloy and turbine-component grinding.', 'Tool-and-die grinding of hardened tool steels and HSS.'],
        applicationsNote: 'High-volume ferrous grinding where the wheel has to hold form across long runs.',
      ...
      },
      {
        ...
        intro: ['Micron grades take CBN down to the fine sizing used in finish grinding, honing, and superfinishing of ferrous parts, sized by measurement rather than sieve.'],
        applicationsTitle: 'Typical Applications',
        applications: ['Honing of cylinder and precision bores.', 'Finish grinding of hardened bearings and gears.', 'Superfinishing of ferrous precision components where the surface is the deliverable.'],
      ...
      },
      {
        ...
        applicationsNote: 'Automotive and aerospace production is the core, wherever a hardened ferrous part needs a defined finish at production speed.',
    ...
    sections: [
      {
        ...
        applicationsNote: 'Applications where surface finish and edge geometry are the specification, not a by-product.',
  ...
  /* ==================== 6 · POLYCRYSTALLINE DIAMOND ======================= */
  {
    ...
    sections: [
      {
        ...
        applicationsNote: 'Non-ferrous, high-volume work where edge life per insert drives cost per part.',
      ...
      },
      {
        ...
        applicationsTitle: 'Typical Applications',
        applications: ['Rotary dressing of aluminium oxide and silicon carbide grinding wheels.', 'Form dressing of profile grinding wheels.', 'Stationary and traverse dressing in CNC grinding centres.', 'A higher-consistency alternative to natural diamond dressing tools.'],
        applicationsNote: 'Wherever a wheel has to be trued repeatably and the dressing tool itself has to hold up.',
    ...
    crossLinks: [
      ...
      {
        title: 'Counterpart',
        links: [{ label: 'PCBN discs & blanks (ferrous machining)', href: '/products/cbn#pcbn' }],
      },
      {
  ...
  /* ================== 8 · POLYCRYSTALLINE DIAMOND POWDER ================== */
  {
    ...
    overviewDesc: 'Polycrystalline diamond powder for precision polishing, lapping, and advanced surface finishing.',
    intro: [
