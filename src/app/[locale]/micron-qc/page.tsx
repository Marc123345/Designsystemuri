...
claim to control it. */}
      ...
      <div className="pt-20">
        <QuoteSection eyebrow={t(locale, 'Specify your tolerances')} title={t(locale, 'Request a quote with your QC specification.')} desc={t(locale, 'Send us the grade and the D-values you need documented, and a real person replies within one business day.')} />
      </div>
