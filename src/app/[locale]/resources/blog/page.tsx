  ...
  return (
    <>
      <PageHero
        ...
        crumbs={[{ label: t(locale, 'Home'), href: '/' }, { label: t(locale, 'Resources'), href: '/resources' }, { label: t(locale, 'Blog') }]}
      ...
      <section className="border-default-200 bg-default-50 mt-14 border-y py-16 lg:py-24">
        <div className="container">
          ...
          <p className="text-default-500 mt-12 text-center text-sm">{t(locale, 'Coming soon. Content hub launches with the site.')}</p>
        </div>
      </section>
